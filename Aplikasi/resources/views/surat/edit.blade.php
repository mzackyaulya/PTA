...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Edit Surat Permohonan</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="jenis_surat" id="jenis_surat" class="form-control" required>
                            ...
                            <option value="dispensasi"
                                {{ old('jenis_surat', $surat->jenis_surat) == 'dispensasi' ? 'selected' : '' }}>
                                Surat Dispensasi
                            </option>

                            <option value="permohonan_lomba"
                                {{ old('jenis_surat', $surat->jenis_surat) == 'permohonan_lomba' ? 'selected' : '' }}>
                                Surat Permohonan Lomba
                            </option>

                            <option value="permohonan_organisasi"
                                {{ old('jenis_surat', $surat->jenis_surat) == 'permohonan_organisasi' ? 'selected' : '' }}>
                                Surat Permohonan Organisasi
                            </option>

                            <option value="izin_kegiatan"
                                {{ old('jenis_surat', $surat->jenis_surat) == 'izin_kegiatan' ? 'selected' : '' }}>
                                Surat Izin Kegiatan
                            </option>

                            <option value="keterangan"
                                {{ old('jenis_surat', $surat->jenis_surat) == 'keterangan' ? 'selected' : '' }}>
                                Surat Keterangan
                            </option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text"
                               ...
                               class="form-control"
                               value="{{ old('tempat_kegiatan', $surat->tempat_kegiatan) }}"
                    ...
                    <div class="col-md-6 mb-3" id="field_pelatih">
                        ...
                        <input type="text"
                               name="nama_pelatih"
                               class="form-control"
                               value="{{ old('nama_pelatih', $surat->nama_pelatih) }}"
                    ...
                    <div class="col-md-6 mb-3" id="field_organisasi">
                        ...
                        <input type="text"
                               ...
                               class="form-control"
                               value="{{ old('nama_organisasi', $surat->nama_organisasi) }}"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        @php
                            $selectedSiswa = old(
                                'siswa_ids',
                                $surat->siswaTerlibat->pluck('id')->toArray()
                            );
                        @endphp
                        ...
                        <select name="siswa_ids[]" class="form-control" multiple>
                            @foreach ($siswas as $siswa)
                                <option value="{{ $siswa->id }}"
                                    {{ collect($selectedSiswa)->contains($siswa->id) ? 'selected' : '' }}>
                        ...
                        <small class="text-muted">
                            Tekan Ctrl untuk memilih lebih dari satu siswa.
                        </small>
                    </div>
