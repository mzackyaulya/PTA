    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card">
                    <div class="card-body">
                        {{-- Pastikan mengarah ke route update dan mengirimkan ID siswa --}}
                        <form action="{{ route('siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label class="form-label text-danger">Password (Kosongkan jika tidak ingin mengubah
                                    password)</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="kewarganegaraan" class="form-select">
                                        <option value="">- Pilih -</option>
                                        <option value="WNI"
                                            {{ old('kewarganegaraan', $siswa->kewarganegaraan) == 'WNI' ? 'selected' : '' }}>WNI
                                        </option>
                                        <option value="WNA"
                                            {{ old('kewarganegaraan', $siswa->kewarganegaraan) == 'WNA' ? 'selected' : '' }}>WNA
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="jenis_tinggal" class="form-select">
                                        ...
                                        <option value="Bersama Orang Tua"
                                            {{ old('jenis_tinggal', $siswa->jenis_tinggal) == 'Bersama Orang Tua' ? 'selected' : '' }}>
                                        ...
                                        <option value="Panti Asuhan"
                                            {{ old('jenis_tinggal', $siswa->jenis_tinggal) == 'Panti Asuhan' ? 'selected' : '' }}>
                                            Panti Asuhan</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="alat_transportasi" class="form-select">
                                        ...
                                        <option value="Jalan Kaki"
                                            {{ old('alat_transportasi', $siswa->alat_transportasi) == 'Jalan Kaki' ? 'selected' : '' }}>
                                            Jalan Kaki</option>
                                        <option value="Sepeda"
                                            {{ old('alat_transportasi', $siswa->alat_transportasi) == 'Sepeda' ? 'selected' : '' }}>
                                            Sepeda</option>
                                        <option value="Motor"
                                            {{ old('alat_transportasi', $siswa->alat_transportasi) == 'Motor' ? 'selected' : '' }}>
                                            Motor</option>
                                        <option value="Mobil"
                                            {{ old('alat_transportasi', $siswa->alat_transportasi) == 'Mobil' ? 'selected' : '' }}>
                                            Mobil</option>
                                        <option value="Angkutan Umum"
                                            {{ old('alat_transportasi', $siswa->alat_transportasi) == 'Angkutan Umum' ? 'selected' : '' }}>
                                            Angkutan Umum</option>
                                        <option value="Ojek"
                                            {{ old('alat_transportasi', $siswa->alat_transportasi) == 'Ojek' ? 'selected' : '' }}>
                                            Ojek</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="pendidikan_ayah" class="form-select">
                                        ...
                                        @php $pendidikans = ['Tidak Sekolah', 'SD / Sederajat', 'SLTP / Sederajat', 'SLTA / Sederajat', 'Diploma I', 'Diploma II', 'Diploma III', 'S1', 'Magister', 'Doktor']; @endphp
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="kebutuhan_khusus" class="form-select">
                                        <option value="">- Pilih -</option>
                                        <option value="IYA"
                                            {{ old('kebutuhan_khusus', $siswa->kebutuhan_khusus) == 'IYA' ? 'selected' : '' }}>
                                            IYA</option>
                                        <option value="TIDAK"
                                            {{ old('kebutuhan_khusus', $siswa->kebutuhan_khusus) == 'TIDAK' ? 'selected' : '' }}>
                                            TIDAK</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="status_siswa" class="form-select">
                                        <option value="aktif"
                                            {{ old('status_siswa', $siswa->status_siswa) == 'aktif' ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="lulus"
